...
def download_and_save_tweets(tw_handle, download_path):
    with open(download_path + "/" + tw_handle + "/tweets.csv", "w") as fp:
        ...
        for tweet in tweepy.Cursor(api.user_timeline,id=tw_handle,tweet_mode='extended').items():
            ...
            while json_tweet: 
                ...
                # Tweet details
                out = out + ";\"" + str(json_tweet.get("truncated", "")) + "\";\"" + json_tweet.get("full_text","").encode('utf-8') + "\";\"" + str(json_tweet.get("is_quote_status","")) + "\";\"" + str(json_tweet.get("quote_count","")) + "\";\"" + str(json_tweet.get("favorite_count","")) + "\";\"" + json_tweet.get("source","").encode('utf-8') + "\";\"" + str(json_tweet.get("retweeted","")) + "\";\"" + str(json_tweet.get("in_reply_to_screen_name","")) + "\";\"" + str(json_tweet.get("retweet_count","")) + "\";\"" + json_tweet.get("id_str","").encode('utf-8') + "\";\"" + str(json_tweet.get("favorited","")) + "\";\"" + str(json_tweet.get("in_reply_to_user_id_str","")) + "\";\"" + str(json_tweet.get("lang","")) + "\";\"" + json_tweet.get("created_at","").encode('utf-8') + "\";\"" + str(json_tweet.get("in_reply_to_status_id_str","")) + "\";\"" + str(json_tweet.get("quoted_status_id_str","")) + "\";\"" + str(json_tweet.get("reply_count","")) + "\";\"" + str(json_tweet.get("retweet_count","")) + "\";\"" + str(json_tweet.get("favorite_count","")) + "\""
